...
// Exécutable SPM plutôt que projet Xcode : le prototype est jetable, la boucle `swift run`
...
// bloc et le journal du prototype n'apparaît qu'à la fermeture. Or c'est cette sortie qui
